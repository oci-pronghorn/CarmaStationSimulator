...
public class App 
{
    ...
    private void buildApplicationGraph(GraphManager gm) {
        try { 
            ...
            /////////
            WebSocketServerPronghornStage.setRelativeAppFolderRoot(SystemPropertyUtil.get("user.dir")+"/src/main/resources/CarmaDemo"); 
            ////////
            ...
            while (--i >= 0) {
                ...
                WebSocketInterfaceStage interfaceStage = new WebSocketInterfaceStage(gm, fromNetPipes[i], toNetPipes[i]);
